        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-8">
            ...
            <nav className="flex space-x-6">
              <Link href="/dashboard" className="text-gray-600 hover:text-[#F08080]">Mes tickets</Link>
              ...
              <Link href="/dashboard/account" className="text-[#F08080] font-medium">Mon compte</Link>
            </nav>
          </div>
